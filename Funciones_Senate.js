...
var partido = dataSenate.results[0 ].members[i].party;
var results = dataSenate.results;
...
function paintStates(sinRepetidos){
    for(i=0;i<sinRepetidos.length;i++){
        ...
        <option value="ALL" onchange="getOptionStates()" id="ALL">ALL</option>
